...
import (
	...
	roaring2 "github.com/RoaringBitmap/roaring/v2"
...
func (cn *PeerConn) postBitfield() {
	...
	{ v1clone := cn.t._completedPieces.Clone(); v2rb := roaring2.BitmapOf(v1clone.ToArray()...); cn.sentHaves = bitmap.Bitmap{RB: v2rb} }
}
