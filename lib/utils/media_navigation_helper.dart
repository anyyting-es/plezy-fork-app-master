...
Future<MediaNavigationResult> navigateToMediaItem(
  ...
  // AniList items have no server — they cannot be played directly.
  // Always route them to the detail screen where stream resolution happens.
  if (mi.backend == MediaBackend.anilist) {
