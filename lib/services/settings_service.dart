...
class SettingsService extends BaseSharedPreferencesService {
  ...
  static const autoSelectExtensionStream = BoolPref('auto_select_extension_stream', defaultValue: true);
  static const showTorrentSpeedInPlayer = BoolPref('show_torrent_speed_in_player', defaultValue: true);
  static const keepDownloadedTorrentFiles = BoolPref('keep_downloaded_torrent_files', defaultValue: false);
  static const backendWorkingLocation = StringPref('backend_working_location');
  static const downloadsLocation = StringPref('downloads_location');
  static const useRemoteBackend = BoolPref('use_remote_backend');
  static const remoteBackendUrl = StringPref('remote_backend_url', defaultValue: 'http://192.168.1.50:9876');
  static const allowLanConnections = BoolPref('allow_lan_connections', defaultValue: false);
  static const backendPin = StringPref('backend_pin', defaultValue: '');
  static const remoteBackendPin = StringPref('remote_backend_pin', defaultValue: '');
  static const disabledExtensions = StringListPref('disabled_extensions');
  ...
  static const useDedicatedGpu = BoolPref('use_dedicated_gpu');
