...
class _PlaybackSettingsScreenState extends State<PlaybackSettingsScreen> {
          ...
          children: [
            SettingsGroup(
              ...
              children: [
                ...
                if (Platform.isLinux) _gpuSelectionTile(),
  ...
  Widget _gpuSelectionTile() => SettingSwitchTile(
    pref: SettingsService.useDedicatedGpu,
    icon: Symbols.developer_board_rounded,
    title: 'Utilizar gráfica dedicada (NVIDIA/AMD)',
    subtitle: 'Relanzará la aplicación para ejecutarse usando PRIME si está disponible.',
    onAfterWrite: (v) async {
      final confirm = await showConfirmDialog(
        context,
        title: 'Reiniciar aplicación',
        message: 'Para aplicar el cambio de GPU, la aplicación debe reiniciarse. ¿Quieres reiniciar ahora?',
      ...
      if (confirm && mounted) {
        try {
          ...
          if (v) {
            ...
            newEnv.remove('__NV_PRIME_RENDER_OFFLOAD');
            newEnv.remove('__GLX_VENDOR_LIBRARY_NAME');
            newEnv.remove('DRI_PRIME');
          }
          await Process.start(
