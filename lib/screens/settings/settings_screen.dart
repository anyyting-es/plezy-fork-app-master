...
class _SettingsScreenState extends State<SettingsScreen> with FocusableTab, MountedSetStateMixin {
  ...
  Widget _buildBackendTile() {
    return SettingNavigationTile(
      focusNode: _focusTracker.get('backend_settings'),
      icon: Symbols.dns_rounded,
      title: 'Ajustes del Backend',
      subtitle: 'Motor BitTorrent local y opciones del reproductor',
      destinationBuilder: (context) => const BackendSettingsScreen(),
    );
  }
  ...
  Widget _buildExtensionsTile() {
    return SettingNavigationTile(
      focusNode: _focusTracker.get('extensions_settings'),
      icon: Symbols.extension_rounded,
      title: 'Extensiones',
      subtitle: 'Administrar, activar, desactivar o instalar extensiones',
      destinationBuilder: (context) => const ExtensionsSettingsScreen(),
    );
  }
