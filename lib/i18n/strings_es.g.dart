...
class _TranslationsDownloadsEs extends TranslationsDownloadsEn {
	...
	@override String get manageTitle => 'Gestor de Descargas';
	@override String get technicalDetails => 'Detalles Técnicos';
	@override String get showTechnical => 'Mostrar Detalles Técnicos';
	@override String get hideTechnical => 'Ocultar Detalles Técnicos';
	@override String get activeDownloads => 'Descargas Activas';
	@override String get noActiveDownloads => 'No hay descargas activas';
	...
	@override String get seeds => 'Semillas';
	@override String get peers => 'Pares';
	@override String get eta => 'Tiempo Restante';
	@override String downloadedOf({required Object downloaded, required Object total}) => 'Descargado ${downloaded} de ${total}';
	@override String get downloading => 'Descargando';
	@override String get deleted => 'Eliminado';
	@override String get deleteConfirmTitle => 'Eliminar Descarga';
	@override String get deleteConfirmMessage => '¿Seguro que deseas eliminar esta descarga?';
	@override String get deleteConfirmCheckbox => 'Eliminar también los archivos locales del disco';
	@override String get torrentInfo => 'Info del Torrent';
}
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'downloads.manageTitle' => 'Gestor de Descargas',
			'downloads.technicalDetails' => 'Detalles Técnicos',
			'downloads.showTechnical' => 'Mostrar Detalles Técnicos',
			'downloads.hideTechnical' => 'Ocultar Detalles Técnicos',
			...
			'downloads.seeds' => 'Semillas',
			'downloads.peers' => 'Pares',
			'downloads.eta' => 'Tiempo Restante',
			'downloads.downloadedOf' => ({required Object downloaded, required Object total}) => 'Descargado ${downloaded} de ${total}',
			'downloads.downloading' => 'Descargando',
			'downloads.deleted' => 'Eliminado',
			_ => null,
		} ?? switch (path) {
			'downloads.deleteConfirmTitle' => 'Eliminar Descarga',
			'downloads.deleteConfirmMessage' => '¿Seguro que deseas eliminar esta descarga?',
			'downloads.deleteConfirmCheckbox' => 'Eliminar también los archivos locales del disco',
			'downloads.torrentInfo' => 'Info del Torrent',
