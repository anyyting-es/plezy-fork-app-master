...
class HubSectionState extends State<HubSection> with MountedSetStateMixin {
  ...
  double get _leadingPadding => widget.inset ? 0.0 : 16.0;
  ...
  Widget build(BuildContext context) {
    ...
    final leadingPadding = _leadingPadding;
              ...
              child: SettingsBuilder(
                ...
                builder: (context) => LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    final baseCardWidth = GridSizeCalculator.getCellWidth(constraints.maxWidth, context, density);
