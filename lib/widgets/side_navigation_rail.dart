        ...
        child: InkWell(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: () {
                if (isFocused) return Colors.black.withValues(alpha: 0.65);
                if (showSelectedBackground) return Colors.black.withValues(alpha: 0.45);
                return null;
              }(),
              borderRadius: borderRadius,
              border: isFocused ? Border.all(color: Colors.white.withValues(alpha: 0.3), width: 1) : null,
              boxShadow: isFocused || showSelectedBackground
                  ? [
                      BoxShadow(
