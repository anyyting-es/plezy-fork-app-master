...
import '../torrent_realtime_viewer.dart';
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            StreamBuilder<List<TorrentInfo>>(
              stream: TorrentEngineService.instance.watchTorrents(),
              builder: (context, snapshot) {
                if (!SettingsService.instance.read(SettingsService.showTorrentSpeedInPlayer)) {
                ...
                final activeTorrent = torrents.first;
                final text = '${activeTorrent.progressFormatted} • ${formatSpeed(speed)}';
                ...
                return InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Icon(Symbols.downloading, size: 16, color: Colors.white),
